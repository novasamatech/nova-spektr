  ...
  return merge({
    ...
    merge: (a, b) => {
      ...
      return {
        ...
        // Only meaningful while no side supplied valid call data; omitted
        // otherwise so "no mismatch" has a single representation.
        ...(!(b.callData ?? a.callData) && (b.callDataMismatch || a.callDataMismatch)
          ? { callDataMismatch: true }
          : {}),
