...
type OverrideType<T extends PolkadotApi> = Record<ChainId, (client: PolkadotClient) => T>;

const POLKADOT_OVERRIDES: OverrideType<DotApi> = {
  // Polkadot People
...
const KUSAMA_OVERRIDES: OverrideType<KsmApi> = {
  // Kusama People
