import { type dot, type dot_ppl, type ksm, type ksm_ppl } from '@polkadot-api/descriptors';
import { type ChainDefinition, type TypedApi } from 'polkadot-api';

type ChainsDescriptors = 'dot' | 'dot_ppl' | 'ksm' | 'ksm_ppl';
...
export type DotApi = ChainApi<'dot', typeof dot> | ChainApi<'dot_ppl', typeof dot_ppl>;
