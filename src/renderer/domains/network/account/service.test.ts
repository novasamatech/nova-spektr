...
describe('account service', () => {
  ...
  describe('isWalletNameAutoGenerated', () => {
    ...
    it('should treat a GENERATED name as auto-generated', () => {
      expect(check('12Ngn...tvrzv', AccountNameType.GENERATED)).toBe(true);
    });
    ...
    it('should treat a shortened address stamped CUSTOM as auto-generated', () => {
      expect(check('12Ngn...tvrzv', AccountNameType.CUSTOM)).toBe(true);
      expect(check('DF8Y76...7Xd1Xh', AccountNameType.CUSTOM)).toBe(true);
    });

    it('should treat a pure proxy name stamped CUSTOM as auto-generated', () => {
      expect(check('Any for pure 134Ssw...uTbHNT', AccountNameType.CUSTOM)).toBe(true);
      expect(check('Staking for pure GPE39T...YxNjgZ', AccountNameType.CUSTOM)).toBe(true);
    });
    ...
    it('should treat a wallet with a contact as not auto-generated', () => {
      const { wallet, accounts } = createMultisigWallet('12Ngn...tvrzv', AccountNameType.GENERATED);
