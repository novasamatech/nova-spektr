...
import { Button, AmountInput, Icon, Identicon, Input, InputHint, Block } from '@renderer/components/ui';
...
export const TransferForm = ({
  ...
  return (
    <>
      <Block>
        <form id="transferForm" className="flex flex-col gap-y-5" onSubmit={handleSubmit(submitTransaction)}>
