...
Initiator, Signed/Status, Actions) and the transient "a column is being dragged" flag. Shared by the operations rows,
the drafts rows and the sticky column header so all three grids stay aligned.
