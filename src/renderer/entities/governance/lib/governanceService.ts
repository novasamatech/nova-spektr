...
// function subscribeReferendumsFx(api: ApiPromise, callback: (referendums?: Referendum[]) => void): Promise<() => void> {
//   console.log(1, 'referendums');

//   return api.query.referenda.referendumInfoFor(1, (referendums: any) => {
