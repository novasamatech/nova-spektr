import { Wallet_NEW, WalletType } from '@shared/core';
...
describe('entities/wallet/lib/wallet-xcm-utils.ts', () => {
  test('isPolkadotVault should return true if wallet type is PolkadotVault', () => {
    const wallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.POLKADOT_VAULT };
  ...
  test('isPolkadotVault should return false if wallet type is not PolkadotVault', () => {
    const wallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.NOVA_WALLET };
  ...
  test('isMultiShard should return true when wallet type is MultiShard', () => {
    const wallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.MULTISHARD_PARITY_SIGNER };
  ...
  test('isMultisig should return true when wallet type is Multisig', () => {
    const wallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.MULTISIG };
  ...
  test('isProxied should return true when wallet type is Proxied', () => {
    const wallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.PROXIED };
  ...
  test('isSingleShard should return true when wallet type is SingleShard', () => {
    const wallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.SINGLE_PARITY_SIGNER };
  ...
  test('isWalletConnect should return true when wallet type is WALLET_CONNECT', () => {
    const wallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.WALLET_CONNECT };
  ...
  test('isWatchOnly should return true when wallet type is WATCH_ONLY', () => {
    const wallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.WATCH_ONLY };
  ...
  test('isWalletConnectGroup should return true when wallet type is in wallet connect group', () => {
    const walletConnect: Pick<Wallet_NEW, 'type'> = { type: WalletType.WALLET_CONNECT };
    const novaWallet: Pick<Wallet_NEW, 'type'> = { type: WalletType.NOVA_WALLET };
  ...
  test('isWalletConnectGroup should return true when wallet type is in wallet connect group', () => {
    const singleshard: Pick<Wallet_NEW, 'type'> = { type: WalletType.SINGLE_PARITY_SIGNER };
    const multishard: Pick<Wallet_NEW, 'type'> = { type: WalletType.MULTISHARD_PARITY_SIGNER };
    const polkadotVault: Pick<Wallet_NEW, 'type'> = { type: WalletType.POLKADOT_VAULT };
