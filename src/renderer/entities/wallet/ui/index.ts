...
export { WalletCardMd } from '@renderer/entities/wallet/ui/Cards/WalletCardMd/WalletCardMd';
export { WalletCardLg } from '@renderer/entities/wallet/ui/Cards/WalletCardLg/WalletCardLg';
