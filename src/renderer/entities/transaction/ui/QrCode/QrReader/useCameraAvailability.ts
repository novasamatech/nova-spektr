...
import { getVideoDevices, requestAccess, stopMediaStream } from '@/shared/ui-kit/QrReader/helpers';
import { type QrReaderError, QrReaderErrorCode } from '@/shared/ui-kit/QrReader/types';
