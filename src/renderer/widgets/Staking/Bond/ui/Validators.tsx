  ...
  return (
    <div className="w-[784px] max-h-[660px] py-4">
      ...
      <div className="flex justify-between mt-7 px-5">
        ...
        <Button disabled={false} onClick={() => validatorsModel.events.formSubmitted()}>
          {/*<Button disabled={nextStepDisabled} onClick={onCompleteValidators}>*/}
          {4 ? t('staking.validators.continueButton', { selected: 4 }) : t('staking.validators.selectValidatorButton')}
        </Button>
      </div>
    </div>
  );
