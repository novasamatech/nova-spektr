...
import { RemovePureProxiedRules } from '@/src/renderer/features/operations/OperationsValidation';
...
const $account = $formStore.map((store) => (store ? store.proxiedAccount : null), { skipVoid: false });
