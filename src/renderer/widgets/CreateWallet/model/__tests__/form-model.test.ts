...
import { initiatorWallet, multisigWallet, signerWallet, testApi, testChain } from './mock';
...
describe('widgets/CreateWallet/model/form-model', () => {
  ...
  //   expect(scope.getState(formModel.$availableAccounts)).toEqual([initiatorWallet, signerWallet]);
  // });
});
