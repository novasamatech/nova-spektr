...
const Content = ({ children }: PropsWithChildren) => {
  ...
  return (
    <RadixPopover.Portal container={portalContainer}>
      ...
      >
        <div className="z-50 h-fit max-h-[--radix-popper-available-height] min-h-0 overflow-hidden rounded-md border border-token-container-border bg-block-background-default text-body shadow-shadow-2 duration-100 animate-in fade-in zoom-in-95">
          {children}
        </div>
      </RadixPopover.Content>
    </RadixPopover.Portal>
