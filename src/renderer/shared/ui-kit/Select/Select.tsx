  ...
  return (
    <RadixSelect.Item
      ...
      className={cnTw(
        ...
        'data-highlighted:bg-action-background-hover focus:bg-action-background-hover focus:outline-hidden',
        {
          'data-highlighted:bg-background-item-hover text-text-tertiary focus:bg-block-background-hover':
            theme === 'dark',
        },
      )}
      style={
