...
const CONFIG_URL = `https://raw.githubusercontent.com/novasamatech/nova-spektr-utils/main/chains/${CONFIG_VERSION}/`;

async function getChainsData(): Promise<Chain[]> {
  const response = await fetch(CONFIG_URL + CHAINS_FILE);
