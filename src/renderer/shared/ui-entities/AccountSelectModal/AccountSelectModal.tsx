...
const AccountItem = ({ asset, account, chain, title, balance, onSelect }: ItemProps) => {
  ...
  return (
    <button
      className="group flex w-full cursor-pointer items-center gap-2 overflow-hidden rounded-sm px-2 py-1.5 text-left text-body text-text-secondary hover:bg-action-background-hover hover:text-text-primary"
