...
export const WalletCard = ({ title, description, iconName, disabled, onClick, testId = 'WelcomeCard' }: Props) => {
  const { t } = useI18n();
  ...
  return (
    <button
      ...
      className={cnTw(
        ...
        {
          'bg-block-background-default text-text-primary shadow-card-shadow hover:shadow-card-shadow-level2': !disabled,
