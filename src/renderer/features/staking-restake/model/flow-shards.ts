...
import { type NetworkStore, type RestakeStoreShards, Step } from '../lib/types';
...
const $restakeStore = createStore<RestakeStoreShards | null>(null).reset(flowFinished);
...
export const restakeFlowShards = {
  $step,
  $networkStore,
  $initiatorWallet,
