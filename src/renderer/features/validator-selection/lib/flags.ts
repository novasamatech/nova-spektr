 ...
 * unselectable; a slash is the strongest reason not to pick a selectable one; a
 * third validator of an operator the user already picked twice weakens their
 * spread; and "no identity" is the mildest - it says only that we cannot name
 * who runs it.
 *
