...
import { type NetworkStore, type WithdrawDataShards, Step } from '../lib/types';
...
const $withdrawData = createStore<WithdrawDataShards | null>(null).reset(flowFinished);
...
export const withdrawFlowShards = {
  $step,
  $networkStore,
  $initiatorWallet,
