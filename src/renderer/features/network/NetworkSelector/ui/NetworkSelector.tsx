        ...
        <div className="relative">
          <Listbox.Button
            className={cnTw(
              ...
              'border-filter-border text-footnote rounded-sm border px-3 py-[7px] outline-offset-1',
          ...
          >
            <div
              ref={ref}
              className="shadow-card-shadow border-token-container-border bg-input-background absolute z-20 mt-1 w-full rounded-sm border px-1 py-1"
            >
