...
Value labels are printed above the bars only while they fit — up to **13 bars**. On `30d`, where they do not, hovering
dims the other bars instead so the pointed-at one is still identifiable.
