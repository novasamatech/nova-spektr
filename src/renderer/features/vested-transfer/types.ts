...
export enum RowErrors {
  ...
  LOCKED_NOT_POSITIVE_NUMBER = 'LOCKED_NOT_POSITIVE_NUMBER',
  LOCKED_TOO_LOW = 'LOCKED_TOO_LOW',
  START_BLOCK_NOT_POSITIVE_NUMBER = 'START_BLOCK_NOT_POSITIVE_NUMBER',
  START_BLOCK_IN_PAST = 'START_BLOCK_IN_PAST',
  START_BLOCK_TOO_HIGH = 'START_BLOCK_TOO_HIGH',
  PER_BLOCK_NOT_POSITIVE_NUMBER = 'PER_BLOCK_NOT_POSITIVE_NUMBER',
