...
import { type BondExtraData, type FeeData, type NetworkStore, Step } from '../lib/types';
...
const $walletData = restore<NetworkStore | null>(flowStarted, null).reset(flowFinished);
...
export const bondExtraFlowShards = {
  $step,
  $walletData,
