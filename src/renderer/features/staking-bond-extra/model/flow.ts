...
import { type NetworkStore, Step } from '../lib/types';
...
const $walletDataShards = restore<NetworkStore | null>(flowStarted, null).reset(flowFinished);
