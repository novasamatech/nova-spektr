 ...
 */
export const MinStakeStepChart = memo(({ rows, scaleWindow, hoveredIndex, formatDate, onHoverChange }: Props) => {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      {/* x labels — era numbers, dates underneath while sparse, thinned so they never overlap */}
      <div className="mt-1.5 flex gap-2">
        ...
        <div className="flex min-w-0 flex-1">
          {rows.map((row, index) => {
            ...
            const secondary = showValueLabels ? date : null;
