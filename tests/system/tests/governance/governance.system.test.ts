...
test.describe('Governance votes for completed referenda', { tag: ['@governance', '@regress'] }, () => {
  [
    { name: 'X1', testData: mockDelegatorVotingsX1, expected: 'AYE 2,000 DOT via 🌌 Novasama 🌌' },
    { name: 'X2', testData: mockDelegatorVotingsX2, expected: 'AYE 4,000 DOT via 🌌 Novasama 🌌' },
